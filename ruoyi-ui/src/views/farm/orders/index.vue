<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="${comment}" prop="shippingaddress">
        <el-input
    ...
    <el-table v-loading="loading" :data="ordersList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="${comment}" align="center" prop="shippingaddress" />
      <el-table-column label="${comment}" align="center" prop="price" />
      <el-table-column label="标识位，0发货，1没发货" align="center" prop="orderstatus" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="${comment}" prop="shippingaddress">
          <el-input v-model="form.shippingaddress" placeholder="请输入${comment}" />
        </el-form-item>
        <el-form-item label="${comment}" prop="price">
...
<script>
import { listOrders, getOrders, delOrders, addOrders, updateOrders } from "@/api/farm/orders";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        orderstatus: [
          { required: true, message: "标识位，0发货，1没发货不能为空", trigger: "blur" }
        ],
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除orders管理编号为"' + orderids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('farm/orders/export', {
        ...this.queryParams
